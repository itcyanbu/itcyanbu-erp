...
const mapAppContactToDbContact = (appContact: any): any => {
    return {
        ...
        email: appContact.email || (appContact.emails && appContact.emails.length > 0 ? appContact.emails[0] : null),
        phone: appContact.phone || (appContact.phones && appContact.phones.length > 0 ? appContact.phones[0] : null),
